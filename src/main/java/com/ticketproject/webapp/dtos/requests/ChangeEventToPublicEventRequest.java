...
/**
 * ChangeEventToPublicEventRequest specifies what a valid request to change
 * an existing event into a public event should look like.
 * 
 * @param publicId the event's public ID
 * @param maxAttendees the maximum number of attendees that can register for the event
 */
@Schema(description = "Request body for changing an event into a public event")
public record ChangeEventToPublicEventRequest
(
    @Schema
    (
